...
def make_shots(dataset_path, h5_file_name, pick_gap):
    ...
    for video_name, video_file in h5in.items():
        ...
        n_frames = seq_len * pick_gap - 1
        # print('n_frames', n_frames)
        picks = np.arange(0, seq_len) * pick_gap
...
if __name__ == '__main__':
    make_shots('../mydatasets/','../mydatasets/vsumm_custom.h5', 10)
